...
with open(r'..\Predicting Employee Attrition - Advanced Classification\model_artifacts\rf.pkl', 'rb') as model_pkl:
    model = pickle.load(model_pkl)


#Load the saved ColumnTransformer using pickle
with open(r'..\Predicting Employee Attrition - Advanced Classification\model_artifacts\ct.pkl', 'rb') as ct_pkl:
    ct = pickle.load(ct_pkl)

#Load the saved scaler using pickle
with open(r'..\Predicting Employee Attrition - Advanced Classification\model_artifacts\sc.pkl', 'rb') as sc_pkl:
...
#Define a function to drop specific (duplicate) columns
